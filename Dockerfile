...
LABEL org.opencontainers.image.source=https://github.com/aserto-dev/aserto-idp-sync
LABEL org.opencontainers.image.title="aserto-idp-sync"
LABEL org.opencontainers.image.revision=$COMMIT
LABEL org.opencontainers.image.url="https://aserto.com"

RUN apk add --no-cache bash
WORKDIR /app
COPY --from=build /src/dist/aserto-idp-sync_linux_amd64/aserto-idp-sync /app/

ENTRYPOINT ["./aserto-idp-sync"]
